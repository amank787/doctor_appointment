...
const DoctorProfile = () => {
  ...
  const relatedDoctors = [
    { id: 1, name: "Dr. Richard James", specialty: "Cardiologist", img: "/images/doc1.png" },
    { id: 2, name: "Dr. Richard James", specialty: "Dermatologist", img: "/images/doc2.png" },
    { id: 3, name: "Dr. Richard James", specialty: "Neurologist", img: "/images/doc3.png" },
    { id: 4, name: "Dr. Richard James", specialty: "Orthopedic", img: "/images/doc4.png" },
    { id: 5, name: "Dr. Richard James", specialty: "Pediatrician", img: "/images/doc5.png" },
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="max-w-5xl mx-auto px-4 py-10">
        <div className="bg-white rounded-2xl shadow p-6 flex flex-col md:flex-row gap-6">
          ...
          <div>
            ...
            <p className="text-gray-500">MBBS, MD – General Medicine | Cardiologist</p>
            <p className="mt-2 text-gray-600">
              Dr. Richard James is a highly experienced cardiologist specializing in general
              medicine. With over 15 years of expertise, he provides patient-centered care,
      ...
      <section className="bg-gray-50 py-10">
        <div className="max-w-5xl mx-auto px-4">
          <h3 className="text-xl font-semibold mb-6 text-center">Related Doctors</h3>
