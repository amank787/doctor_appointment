        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <p className="text-gray-600 mb-4">
              ...
              and accessing timely medical consultations. That’s why we’ve
              developed an innovative platform that connects patients with
              qualified healthcare professionals seamlessly.
            </p>
            <p className="text-gray-600 mb-4">
              Our mission is simple: to make healthcare more accessible and
              hassle-free for everyone. Whether you need a routine check-up,
              have a medical concern, or require specialist consultation,
              Prescripto is here to streamline the process for you.
            </p>
            <p className="text-gray-600">
              ...
              quality care and ensuring that you receive the attention and
              support you deserve.
            </p>
          </div>
        </div>
